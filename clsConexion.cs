...
namespace CapaDatos
{
    public class clsConexion
    {
        ...
        {
            return "Data Source=JUAN-PC\\SQLEXPRESS;Initial Catalog=Notas;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        }
        ...
        private bool AbrirConexion()
        {
            ...
            objConexionDB.ConnectionString = GetObtenerCadenaConexion();
                try
                {
                    objConexionDB.Open();
                    return true;
